...
Upload a file containing list of coordinates (*.csv, .txt, or .geojson*). The file should contain columns of x-coordinate, y-coordinate, and an ID column unique for each row.  For example:  
